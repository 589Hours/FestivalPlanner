...
public class Stage implements Serializable {
    ...
    // Methode om het podiumnummer in te stellen
    public void setStageNumber(int stageNumber) {
        this.stageNumber = stageNumber; // Wijs het opgegeven podiumnummer toe aan het podium
    }

    // Methode om het podiumnummer op te vragen
